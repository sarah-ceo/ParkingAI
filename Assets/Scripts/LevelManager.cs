...
public class LevelManager : MonoBehaviour
{
    ...
    public void InitLevel(GameObject[] carAgents)
    {
        if (!isInit)
        {
            SpawnCarsAndTarget(carAgents);
        }
        isInit = true;
    ...
    private void SpawnCarsAndTarget(GameObject[] carAgents)
    {
        ...
        if (carAgents != null)
        {
            ...
            */
            ...
            foreach (GameObject carAgent in carAgents)
            {
